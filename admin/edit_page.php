...
<h1 class="mt-4">Edit Page: <?php echo htmlspecialchars($page['title']); ?></h1>
...
<!-- Include custom editor CSS in the footer to ensure it's loaded -->
...
<!-- Include custom editor JS at the end of the body -->
